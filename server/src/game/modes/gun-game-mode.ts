...
export class GunGameMode implements GameMode {
   ...
   * infinite_ammo fights the reserve-floor economy. Both stay out of this
   * mode's random rolls (FORCE_* env pins still bypass — smoke tools).
   */
  readonly excludedMutators: readonly MutatorId[] = ['grenades_only', 'infinite_ammo'];
