...
Quick Match launches as 1v1; Wasteland Rumble launches with 2–4 players. The game remains architected for N players. Use arrays/maps of players everywhere — never hardcode `player1`/`player2` or assume exactly 2 players. Matchmaking, game state, and rendering must all support variable player counts.
